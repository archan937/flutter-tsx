    ...
    <style>
      ...
      *::after {
      ...
      .brand .mark {
        ...
        font-weight: 800;
        font-size: 1.05rem;
        box-shadow: 0 0 0 1px rgba(255, 255, 255, 0.12) inset, 0 6px 18px rgba(84, 164, 255, 0.4);
      }
      .brand b {
        background: var(--grad);
  ...
  <body>
    ...
    <nav>
      <div class="wrap nav-inner">
        <a class="brand" href="#top">
          <span class="mark"><svg width="18" height="18" viewBox="0 0 32 32" fill="none" aria-hidden="true"><g stroke="#06121f" stroke-width="3.4" stroke-linecap="round" stroke-linejoin="round"><path d="M8 9 L15 16 L8 23" /><path d="M16 9 L23 16 L16 23" /></g></svg></span>
    ...
    <main class="wrap" id="top">
      <header>
        ...
        <p class="lead reveal">
          Build cross-platform Flutter apps in <b>TypeScript&nbsp;+&nbsp;JSX</b>.
